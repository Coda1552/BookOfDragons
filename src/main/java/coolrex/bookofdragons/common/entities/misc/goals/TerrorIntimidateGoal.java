...
import coolrex.bookofdragons.common.entities.TerribleTerror;
...
public class TerrorIntimidateGoal extends Goal {
    ...
    public TerrorIntimidateGoal(TerribleTerror entity){
        this.entity = entity;
    }

    @Override
    public boolean canUse() {
        List<? extends BaseDragonEntity> list = this.entity.level().getNearbyEntities(BaseDragonEntity.class, SNAP_AT_TARGETTING, this.entity, this.entity.getBoundingBox().inflate(32.0D));
        return !list.isEmpty();
    }
    ...
    public void tick() {
        ...
        if(this.coolDown < 60){
            ...
            List<? extends BaseDragonEntity> list = this.entity.level().getNearbyEntities(BaseDragonEntity.class, SNAP_AT_TARGETTING, this.entity, this.entity.getBoundingBox().inflate(32.0D));
                if(!(list.get(0) instanceof TerribleTerror)) {
